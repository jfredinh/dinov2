{
  inputs = {
    ...
    nixpkgs_nsys.url = "github:leoank/nixpkgs/cuda12_8";
  ...
  outputs =
    ...
    flake-utils.lib.eachDefaultSystem (
      ...
      let
        ...
        npkgs = import inputs.nixpkgs_nsys {
          inherit system;
          config.allowUnfree = true;
          config.cudaSupport = true;
        };
        ...
        fhsenv = pkgs.buildFHSEnv {
          ...
          targetPkgs =
            pkgs: with pkgs; [
              ...
              mpkgs.uv
              python311
              npkgs.cudaPackages_12_8.nsight_compute
              npkgs.cudaPackages_12_8.nsight_systems
            ];
          profile = ''
